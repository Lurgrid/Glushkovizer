...
\begin{example}
    ...
    + c \cdot d\), avec \(E \in Exp(\Sigma)\) et \(\Sigma = \{a, b, c,
...
que des symboles uniques. Et que de ce fait si deux couples partages le même
entier cela implique qu'ils ont même valeur de symbole.
